  ...
  return (
    <div className="min-h-dvh bg-[var(--canvas)] text-[var(--ink)]">
      ...
      <main id="main-content" tabIndex={-1}>
        <section className="relative mx-auto grid w-full max-w-[96rem] gap-8 overflow-hidden px-6 py-8 lg:grid-cols-[0.72fr_1.28fr] lg:items-center lg:gap-16 lg:px-12 lg:py-9">
